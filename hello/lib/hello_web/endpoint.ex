defmodule HelloWeb.Endpoint do
  ...
  plug(Plug.Static,
    at: "/",
    from: :hello,
    # This can be set to true when deploying to production to gzip the static files
    gzip: false,
  ...
  # Generates a unique id for easch request
  plug(Plug.RequestId)
